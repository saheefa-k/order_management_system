defmodule OrderManagementSystem.Accounts.UserToken do
  use Ecto.Schema
  import Ecto.Query
  alias OrderManagementSystem.Accounts.UserToken
  ...
  schema "users_tokens" do
    ...
    belongs_to :user, OrderManagementSystem.Accounts.User
