defmodule OrderManagementSystemWeb.UserAuthTest do
  use OrderManagementSystemWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias OrderManagementSystem.Accounts
  alias OrderManagementSystem.Accounts.Scope
  alias OrderManagementSystemWeb.UserAuth

  import OrderManagementSystem.AccountsFixtures
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      OrderManagementSystemWeb.Endpoint.subscribe(live_socket_id)
  ...
  describe "disconnect_sessions/1" do
    test "broadcasts disconnect messages for each token" do
      ...
      for %{token: token} <- tokens do
        OrderManagementSystemWeb.Endpoint.subscribe("users_sessions:#{Base.url_encode64(token)}")
      end
